...
// slog messages to the format expected by DeepSource.  The format is:
//
// {
...
//
// To log a message:
// 	dslog.Debug("hello world", slog.String("name", "deepsourcelabs"), slog.Int("age", 1))
//
